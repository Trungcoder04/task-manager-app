...
export class TasksService {
  ...
  async requestExtension(
    ...
    // Chỉ Người được giao thực hiện công việc (Assignee) mới có quyền gửi yêu cầu xin gia hạn!
    if (!task.assigneeId || task.assigneeId !== currentUserId) {
      throw new AppException(ErrorCode.UNAUTHORIZED, 'Chỉ Người được giao thực hiện công việc mới có quyền gửi yêu cầu xin gia hạn.');
    }
